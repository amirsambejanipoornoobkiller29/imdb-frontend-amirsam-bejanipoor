export async function fetchExclusive() {
  try {
    ...
    let exclusive = res.exclusive.map(function (slide) {
      return `
    ...
    document
      .querySelectorAll(".exclusive-container .swiper-wrapper")
      .forEach((wrapper) => {
        wrapper.innerHTML = exclusive.join("");
      });
  } catch (error) {
