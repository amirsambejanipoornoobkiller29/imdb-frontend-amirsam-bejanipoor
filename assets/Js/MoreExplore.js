export async function fetchMoreExplore() {
  try {
    ...
    document
      .querySelectorAll(".more-explore-container .swiper-wrapper")
      .forEach((wrapper) => {
        wrapper.innerHTML = moreExplore.join("");
      });
  } catch (error) {
...
export default fetchMoreExplore();
