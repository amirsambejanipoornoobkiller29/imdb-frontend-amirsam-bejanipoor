export async function fetchUpNext() {
  try {
    ...
    let upnext = res.upNext.map(function (slide) {
      return `
    ...
    document
      .querySelectorAll(".banner-rt .banner-side-content")
      .forEach((wrapper) => {
